                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="width: 450px; height : 350px;" colspan="2"> <iframe src='https://www.google.com/maps?q=<?Php echo $d["latitude"] ?>,<?php echo $d["longitude"]; ?>&hl=es;z=14&output=embed' style="width:100%;  height:100%; "></iframe> </td>
                                <td class="text-center"><img src="/ProjectPLN/file/<?php echo $d['pmet']; ?>" style="width: 250px;"></td>
